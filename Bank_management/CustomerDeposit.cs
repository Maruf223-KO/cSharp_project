...
namespace Bank_management
{
    public partial class CustomerDeposit : Form
    {
        ...
        public CustomerDeposit(string userId)
        {
            InitializeComponent();
            this.UserId = userId;
        }
        ...
        private void btn_deposit_Click(object sender, EventArgs e)
        {
            ...
            string insert_transaction_query = "insert into Transactions values(NULL,(select AccountId from Account where CustomerId=(select CustomerId from Customer where UserId='" + UserId + "')),'" + amount + "','Completed','DEPOSIT',GETDATE(),'do not know')";
            ...
            SqlCommand sql4 = new SqlCommand(insert_transaction_query, con);
                ...
                MessageBox.Show("New balance is :" + accountBalance);
